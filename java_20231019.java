...
public class java_20231019 {
	...
	public static void main(String[] args) {
		...
		//뮨제 int형 x라는 변수를 선언합니다. -> 1;
		//출력결과 :
		//1(선연산후증가)
		//2
		//3(선증가후연산)
		int y = 1; //변수에 증가할 값을 담아낸다
		...
		//출력 결과 : 100
		System.out.println(num_x%num_y); //(100/200)% = 100 니눌수 x
		...
		//이항연산자_관계욘산자 : 크다 / 작다 / 같다 / 같거나 작다 / 같거나 크다
		...
		//false (0==0/1==0/0==1) b1 과 b2를 이용해서 false
		System.out.println(b1 && b2);
		//true (1==1)
		System.out.println(b1 && b3);
		//false (0==0/1==0/0==1) b2 와 b4를 이용해서 false
		System.out.println(b2 && b4);
		
		System.out.println("###논리랍(OR):둘중 하나라도 true=1###");
		//true
		System.out.println(b1 || b2);
		//true
